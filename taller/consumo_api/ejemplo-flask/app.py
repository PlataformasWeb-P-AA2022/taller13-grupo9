...
@app.route("/")
def hello_world():
    return "<p>Taller 13 - Uso de apis y servicios de Django</p>"
...
def los_departamentos():
    """
    """
    r = requests.get("http://127.0.0.1:8000/api/departame/",
            auth=(user, passw))
...
def los_departamentos_dos():
    ...
    datos2 = []
    for d in datos:
        datos2.append({'nombre_propietario':d['nombre_propietario'], 'costo':d['costo'], 'numero_cuartos': d['numero_cuartos'],
